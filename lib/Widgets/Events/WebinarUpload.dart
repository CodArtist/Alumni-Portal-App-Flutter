...
class WebinarUpload extends StatefulWidget {
var user;
  WebinarUpload(this.user);
 
  @override
  _WebinarUpload createState() => _WebinarUpload();
}

class _WebinarUpload extends State<WebinarUpload> {
TextEditingController title=new TextEditingController();
TextEditingController location=new TextEditingController();
TextEditingController date=new TextEditingController();
TextEditingController description=new TextEditingController();
TextEditingController webinarLink=new TextEditingController();
...
uploaddata() async{
  if(title.text.isNotEmpty&&location.text.isNotEmpty&&date.text.isNotEmpty&&description.text.isNotEmpty&&webinarLink.text.isNotEmpty)
  {     
    setState(() {
      isLoading=true;
    });
  ...
  return Scaffold(
    appBar: AppBar(title:Text("Upload Webinar"),
    backgroundColor: Colors.red,),
          ...
          child:Container(
            ...
            child:FlatButton(
              onPressed:(()async{
                 ...
                 if(webinarLink.text!="")
                                    {
                                      validUrl=checkUrl(webinarLink.text);
                                    }
                if(await validUrl)
                                    handleSubmit();
                                    else
                                  Fluttertoast.showToast(msg:"Invalid Url of webinar");
              }),
