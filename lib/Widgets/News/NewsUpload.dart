...
var user;
  NewsUpload(this.user);
 
  @override
  _NewsUpload createState() => _NewsUpload();
}

class _NewsUpload extends State<NewsUpload> {
  ...
  { setState(() {
    isLoading=true;
      ...
      final response = await http.post(
         "https://alumniportal2001.000webhostapp.com/AddNews.php", body: {
